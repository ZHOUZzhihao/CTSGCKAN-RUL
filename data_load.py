...
class SequenceDataset(Dataset):
    def __init__(self, mode='pretrain', group=None, y_label=None, sequence_train=50, sequence_test=20, patch_size=10, engine_num=None):
        self.mode = mode
        X_ = []
        y_ = []
        time_stamp = []
        ...
        if mode == 'train_val':
            self.unit_nr_total = len(group["unit_nr"].value_counts())*0.8
            i = 1
